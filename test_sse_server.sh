...
CAPTURE_FILE="captures/sse-server_$(date +%Y%m%d%H%M%S).pcap"
...
echo "Command executed: curl -v \"http://$HOSTNAME:$PORT/events\""
...
# Test SSE endpoint using curl
echo "Testing SSE endpoint..."
curl -v "http://$HOSTNAME:$PORT/events"
